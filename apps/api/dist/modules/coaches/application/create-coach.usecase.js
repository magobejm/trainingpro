...
exports.CreateCoachUseCase = void 0;
const common_1 = require("@nestjs/common");
const coach_admin_repository_port_1 = require("../domain/coach-admin.repository.port");
let CreateCoachUseCase = class CreateCoachUseCase {
    repository;
    constructor(repository) {
        this.repository = repository;
    }
    execute(adminSupabaseUid, input) {
        return this.repository.createCoach(adminSupabaseUid, input);
    }
};
exports.CreateCoachUseCase = CreateCoachUseCase;
exports.CreateCoachUseCase = CreateCoachUseCase = __decorate([
