...
exports.MarkIncidentReviewedUseCase = void 0;
const common_1 = require("@nestjs/common");
const incidents_repository_port_1 = require("../../domain/incidents.repository.port");
let MarkIncidentReviewedUseCase = class MarkIncidentReviewedUseCase {
    incidentsRepository;
    constructor(incidentsRepository) {
        this.incidentsRepository = incidentsRepository;
    }
    execute(context, incidentId) {
        return this.incidentsRepository.markReviewed(context, incidentId);
    }
};
exports.MarkIncidentReviewedUseCase = MarkIncidentReviewedUseCase;
exports.MarkIncidentReviewedUseCase = MarkIncidentReviewedUseCase = __decorate([
