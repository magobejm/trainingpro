...
exports.RespondIncidentUseCase = void 0;
const common_1 = require("@nestjs/common");
const incidents_repository_port_1 = require("../../domain/incidents.repository.port");
let RespondIncidentUseCase = class RespondIncidentUseCase {
    incidentsRepository;
    constructor(incidentsRepository) {
        this.incidentsRepository = incidentsRepository;
    }
    execute(context, incidentId, response) {
        return this.incidentsRepository.addCoachResponse(context, incidentId, response);
    }
};
exports.RespondIncidentUseCase = RespondIncidentUseCase;
exports.RespondIncidentUseCase = RespondIncidentUseCase = __decorate([
