...
exports.TagIncidentUseCase = void 0;
const common_1 = require("@nestjs/common");
const incidents_repository_port_1 = require("../../domain/incidents.repository.port");
let TagIncidentUseCase = class TagIncidentUseCase {
    incidentsRepository;
    constructor(incidentsRepository) {
        this.incidentsRepository = incidentsRepository;
    }
    execute(context, incidentId, tag) {
        return this.incidentsRepository.addTag(context, incidentId, tag);
    }
};
exports.TagIncidentUseCase = TagIncidentUseCase;
exports.TagIncidentUseCase = TagIncidentUseCase = __decorate([
