...
exports.FinishSessionUseCase = void 0;
...
let FinishSessionUseCase = class FinishSessionUseCase {
    repository;
    accessPolicy;
    editWindowPolicy;
    ...
    async execute(context, input, timezoneOffsetMinutes) {
        ...
        const result = await this.repository.finishSession(context, input);
        await this.emitSessionCompletedEventUseCase.execute(result.id);
        return result;
    }
};
exports.FinishSessionUseCase = FinishSessionUseCase;
exports.FinishSessionUseCase = FinishSessionUseCase = __decorate([
