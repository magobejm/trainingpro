...
export const CARDIO_METHODS_V1: CardioMethodSeed[] = [
  ...
  { id: '5d07bd5f-8575-4820-b36d-f98ef261f0ce', methodTypeCode: 'intervalos', name: 'HIIT' },
  {
    id: '4a97bcf9-98d9-4e88-bd8c-d3e7a03f70d1',
    methodTypeCode: 'intervalos',
    name: 'Tempo / Umbral',
  },
  { id: '33c7b878-63f1-4f10-a1da-5f8e2ec4cb9a', methodTypeCode: 'mixto', name: 'Fartlek' },
];
