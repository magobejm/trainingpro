...
export class LogPlioSetUseCase {
  ...
  async execute(context: AuthContext, input: LogPlioSetInput, timezoneOffsetMinutes: number) {
    ...
    return this.repository.logPlioSet(context, input);
  }
}
