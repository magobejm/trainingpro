            ...
            <View style={styles.content}>
                ...
                {expanded && (
                    <View style={styles.detailBox}>
                        <DetailLine
                            label={t('coach.library.exercises.detail.muscleGroup')}
                            value={item.muscleGroup}
                        />
                        <DetailLine
                            label={t('coach.library.exercises.detail.equipment')}
                            value={item.equipment ?? t('coach.library.exercises.detail.empty')}
                        />
                        <DetailLine
                            label={t('coach.library.exercises.detail.instructions')}
                            value={item.instructions ?? t('coach.library.exercises.detail.empty')}
                        />
                        <LibraryMediaViewer
